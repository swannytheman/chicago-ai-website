...
export default function App() {
  ...
  const products = useMemo(() => [
    { icon: Bot, name: "Customer Service AI", tagline: "Answer every question instantly—even at 3am", capabilities: ["Replies to customers in seconds—nights, weekends, holidays", "Sounds like your best employee, not a chatbot", "Works across your website, email, and text messages", "Logs every conversation in your CRM automatically"], pricing: [{ tier: "Starter", monthly: "$129", setup: "$1,800", details: "1,000 conversations/mo" }, { tier: "Pro", monthly: "$299", setup: "$2,900", details: "Unlimited + integrations", popular: true }, { tier: "Enterprise", monthly: "$499", setup: "$4,500", details: "Custom features + priority support" }] },
    { icon: Users, name: "Sales AI", tagline: "Turn website visitors into booked meetings", capabilities: ["Spots your hottest leads and puts them first in line", "Follows up with prospects before they go cold", "Books calls straight to your calendar—no back and forth", "Syncs with your CRM so your pipeline stays full"], pricing: [{ tier: "Starter", monthly: "$179", setup: "$2,200", details: "Core lead qualification" }, { tier: "Pro", monthly: "$399", setup: "$3,500", details: "Full sequences + lead scoring", popular: true }, { tier: "Enterprise", monthly: "$649", setup: "$5,900", details: "Multi-channel + A/B testing" }] },
    { icon: Calendar, name: "Admin AI", tagline: "Automate the busywork you dread every day", capabilities: ["Reads your email, drafts replies, and flags what matters", "Handles scheduling so you never double-book again", "Chases unpaid invoices so you don't have to", "Connects to Google Workspace, QuickBooks, and more"], pricing: [{ tier: "Starter", monthly: "$199", setup: "$2,400", details: "Email + calendar automation" }, { tier: "Pro", monthly: "$399", setup: "$3,900", details: "Full suite + weekly reports", popular: true }, { tier: "Enterprise", monthly: "$699", setup: "$6,200", details: "Custom workflows + integrations" }] },
    { icon: PenTool, name: "Marketing AI", tagline: "Create a month of content in minutes", capabilities: ["Writes blogs, social posts, and emails in your voice", "Keeps your brand consistent across every platform", "Schedules and posts automatically—no more forgetting", "Tracks what's driving clicks, leads, and engagement"], pricing: [{ tier: "Starter", monthly: "$149", setup: "$1,500", details: "20 posts/month" }, { tier: "Pro", monthly: "$299", setup: "$2,800", details: "Unlimited + analytics", popular: true }] }
  ], []);
